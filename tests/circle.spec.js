...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle(Object())).not.toBeDefined();
    ...
    expect(circle(false)).not.toBeDefined();
    ...
    expect(Array.from(Object.entries(circle(3))).join()).toEqual('radius,3,area,28.259999999999998,circumference,18.84');
  });
});
